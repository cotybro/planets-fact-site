...
import planetInternal from '../assets/Images/planet-earth-internal.svg'
...
function Earth() {
  ...
  const [planetContent, setPlanetContent] = useState(
    planetInfo[2].overview.content
  )
  const [planetSource, setPlanetSource] = useState(
    planetInfo[2].overview.source
  )
  ...
  function handleOverviewClick() {
    setPlanetImg(planet)
    setPlanetContent(planetInfo[2].overview.content)
    setPlanetSource(planetInfo[2].overview.source)
    setPlanetGeo(false)
    setPlanetOverview(1)
  }
  ...
  function handleInternalStructureClick() {
    ...
    setPlanetContent(planetInfo[2].structure.content)
    setPlanetSource(planetInfo[2].structure.source)
    setPlanetGeo(false)
    setPlanetOverview(2)
  }
  ...
  function handleSurfaceGeologyClick() {
    setPlanetImg(planet)
    setPlanetContent(planetInfo[2].geology.content)
    setPlanetSource(planetInfo[2].geology.source)
    setPlanetGeo(true)
    setPlanetOverview(3)
  }
    ...
    <Planet>
      <div className='planet__container__top'>
        <div className='planet__mobile__overview'>
          <div
            className={`${
              mobileOverview === 'overview' ? 'earth__overview__active' : ''
          ...
          <div
            className={`${
              mobileOverview === 'structure' ? 'earth__overview__active' : ''
            } mobile__overview__item`}
            onClick={() => {
          ...
          <div
            className={`${
              mobileOverview === 'surface' ? 'earth__overview__active' : ''
            } mobile__overview__item`}
            onClick={() => {
        ...
        <div className='planet__info'>
          <div className='planet__info__header '>
            <p className='planet__name'>{planetInfo[2].name}</p>
          ...
          <div className='overview__container'>
            <div
              className={`overview__item ${
                planetOverview === 1 ? 'earth__active' : ''
              }`}
            ...
            <div
              className={`overview__item ${
                planetOverview === 2 ? 'earth__active' : ''
              }`}
            ...
            <div
              className={`overview__item ${
                planetOverview === 3 ? 'earth__active' : ''
              }`}
      ...
      <div className='planet__container__bottom'>
        <div className='planet__stats'>
          ...
          <p className='stat__number'>{planetInfo[2].rotation}</p>
        </div>
        <div className='planet__stats'>
          <p className='stat__title'>Revolution Time</p>
          <p className='stat__number'>{planetInfo[2].revolution}</p>
        </div>
        <div className='planet__stats'>
          <p className='stat__title'>Radius</p>
          <p className='stat__number'>{planetInfo[2].radius}</p>
        </div>
        <div className='planet__stats'>
          <p className='stat__title'>Average Temp.</p>
          <p className='stat__number'>{planetInfo[2].temperature}</p>
        </div>
      </div>
    </Planet>
  )
