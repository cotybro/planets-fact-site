    ...
    <Planet>
      <div className='planet__container__top'>
        <div className='planet__mobile__overview'>
          <div
            className={`${
              mobileOverview === 'overview' ? 'jupiter__overview__active' : ''
          ...
          <div
            className={`${
              mobileOverview === 'structure' ? 'jupiter__overview__active' : ''
            } mobile__overview__item`}
            onClick={() => {
          ...
          <div
            className={`${
              mobileOverview === 'surface' ? 'jupiter__overview__active' : ''
            } mobile__overview__item`}
            onClick={() => {
        ...
        <div className='planet__img__container jupiter__mb'>
          <img
            src={planetImg}
